...
public class NativeJpaQueryBuilder<T> extends JpaQueryBuilder {
    ...
    public NativeJpaQueryBuilder(EntityManager em, DateTimeService dateTimeService, String query) {
        super(em, query);
        this.dateTimeService = dateTimeService;
    }

    public NativeJpaQueryBuilder(EntityManager em, DateTimeService dateTimeService, String query, boolean appendWhere) {
    ...
    public static JpaQueryBuilder nativeQueryBuilder(EntityManager em, DateTimeService dateTimeService, String query) {
        return new NativeJpaQueryBuilder(em, dateTimeService, query);
    }
    ...
    private List<T> transformIfNeeded(List<Object[]> queryResult) {
        ...
        if (transformer != null) {
            return transform(queryResult, TransformationSource.with(getTransformer(), dateTimeService));
        } else {
