...
public class TransformationSource {
    ...
    public void resetInput(Object... values) {
        ...
        if (cachedValueList == null) {
            cachedValueList = newArrayListWithCapacity(values.length);
    ...
    public static <T> CollectionUtils.Transformer<Object[], T> with(
            final CollectionUtils.Transformer<TransformationSource, T> delegate) {
        final TransformationSource transformationSource = new TransformationSource();
     ...
     */
    public static <T> Function<Object[], T> with(final Function<TransformationSource, T> delegate) {
        final TransformationSource transformationSource = new TransformationSource();
    ...
    public class Value {
        ...
        public DateTime asDateTime() {
            try {
                return asObject() != null ? new DateTime(asObject()) : null;
        ...
        public LocalDate asLocalDate() {
            try {
                return asObject() != null ? new LocalDate(asObject()) : null;
            } catch (IllegalArgumentException ex) {
                throw newConversionException(ex);
            }
        }
