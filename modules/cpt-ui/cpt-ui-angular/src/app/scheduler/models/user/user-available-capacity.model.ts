...
/**
 * <ul>Model representing cpt_user_unavailable_capacity DB table.
 * <li>AvailabilityType.ABSENT and PUBLIC_HOLIDAY: imp_way (imported data from goto/WAY) data is cleansed and pushed into cpt_user_unavailable_capacity for cpt usage.</li>
 * <li>AvailabilityType.ABSENT and PUBLIC_HOLIDAY: Every day as soon as imp_way import finishes, cpt_user_unavailable_capacity needs to be re-calculated/updated.</li>
...
export class UserAvailableCapacityDto {
  ...
  constructor(public uuid: string, //required, cpt_user_unavailable_capacity.uuid
